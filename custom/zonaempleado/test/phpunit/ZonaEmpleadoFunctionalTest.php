...
/**
 * \file    test/phpunit/ZonaEmpleadoFunctionalTest.php
...
/**
 * Class ZonaEmpleadoFunctionalTest
 *
 ...
 *
 * @package Testzonaempleado
 */
class ZonaEmpleadoFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modZonaEmpleado')->click();
		} else {
			// Disable the module
			$this->byHref('modZonaEmpleado')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/zonaempleado/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('zonaempleado/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/zonaempleado/admin/about.php');
		$this->authenticate();
		return $this->assertContains('zonaempleado/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('zonaempleadowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modZonaEmpleado_ZonaEmpleadoTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modZonaEmpleado_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
