...
/**
 * \file    htdocs/custom/signDol/ajax/get_sign_url.php
 * \ingroup docsig
 * \brief   AJAX endpoint para obtener URL de firma (regenerando token)
 */
...
$regenerate = GETPOST('regenerate', 'alpha') == '1';
...
try {
    ...
    // Solo se puede obtener URL para firmantes pendientes
    ...
    $response = array(
        ...
        'message' => $regenerate ? $langs->trans('TokenRegeneratedSuccessfully') : '',
    );
